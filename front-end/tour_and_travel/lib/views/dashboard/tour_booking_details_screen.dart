  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      final dynamic booking = bookingViewModel.bookingHistory.firstWhere(
        (b) => (b['referenceId'] ?? b['id'] ?? 0) == bookingId && (b['type'] ?? 'Tour').toString().toLowerCase() == bookingType.toLowerCase(),
        orElse: () => this.booking,
      );
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            gradient: LinearGradient(
                              colors: [Colors.orange.withOpacity(0.08), Colors.orange.withOpacity(0.03)],
                                ...
                                child: Stack(
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      child: const Icon(Icons.tour, color: Colors.orange, size: 24),
                                    ),
                                  ],
                                ),
                              ),
                        ...
                        // Timeline
                        _buildTimelineItem(
                          title: booking['bookingDate']?.toString().substring(0, 10) ?? "Tour Date",
              ...
              child: ElevatedButton.icon(
                onPressed: () async {
                  ...
                  await Printing.sharePdf(
                    bytes: pdfBytes,
                    filename: 'Invoice_Tour_${DateTime.now().millisecondsSinceEpoch}.pdf',
                  );
                },
