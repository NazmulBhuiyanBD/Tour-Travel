...
class MyFlightBookingsScreen extends StatelessWidget {
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                _buildTimeInfo(
                  _formatTime(departDateTime),
                  _formatDate(departDateTime),
                  const Color(0xFF2D9CDB),
                  CrossAxisAlignment.start,
                ),
                _buildTimeInfo(
                  _formatTime(arriveDateTime),
                  _formatDate(arriveDateTime),
                  const Color(0xFFF2994A),
  ...
  Widget _buildAirportInfo(String code, String city, Color color) {
    return Column(
      crossAxisAlignment: color == const Color(0xFF2D9CDB)
          ? CrossAxisAlignment.start
          : CrossAxisAlignment.end,
      children: [
        Text(
