                ...
                return GridView.count(
                  ...
                  children: [
                    ...
                    _ActionCard(
                      ...
                      onTap: () => Get.to(() => const tour_and_travel_support.AdminTicketListView()),
                    ),
                    _ActionCard(
                      ...
                      iconColor: const Color(0xFF3F51B5),
                      onTap: () => Get.toNamed(Routes.ADMIN_TOP_DESTINATIONS),
                    ),
                    _ActionCard(
                      ...
                      iconColor: const Color(0xFFF9A825),
                      onTap: () => Get.toNamed(Routes.ADMIN_POPULAR_AIRLINES),
                    ),
                    _ActionCard(
                    ...
                    if (authController.user.value.role == 'SuperAdmin')
                      _ActionCard(
                        ...
                        onTap: () => Get.toNamed(Routes.SUPER_ADMIN_MANAGE),
                      ),
                  ],
                );
              }),
          ...
          Row(
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: (isPositive ? const Color(0xFF43A047) : Colors.red).withOpacity(0.1),
                  borderRadius: BorderRadius.circular(10),
                ),
                child: Text(
                  trend,
