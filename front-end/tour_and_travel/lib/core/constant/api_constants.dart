...
class ApiConstants {
  ...
  static const String sendMessage = '/Support/ticket'; // append /{ticketId}/message
  static const String closeTicket = '/Support/ticket'; // append /{ticketId}/close
  static const String supportUpload = '/Support/upload';

  // Admin Endpoints
  static const String adminDashboard = '/Admin/dashboard';
  static const String adminUsers = '/Admin/users';
  static const String adminToggleUser = '/Admin/user/'; // append {id}/toggle-status
  ...
  static const String adminHotel = '/Admin/hotel'; // append /{id} for PUT/DELETE
  
  static const String adminFlights = '/Admin/flights';
  static const String adminFlight = '/Admin/flight'; // append /{id} for PUT/DELETE
  ...
  static const String superAdmins = '/Admin/admins'; 
